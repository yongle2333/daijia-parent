...
public class FeeRuleServiceImpl implements FeeRuleService {
    ...
    //计算订单费用
    @Override
    public FeeRuleResponseVo calculateOrderFee(FeeRuleRequestForm calculateOrderFee) {

        //封装输入对象
        FeeRuleRequest feeRuleRequest = new FeeRuleRequest();
        feeRuleRequest.setDistance(calculateOrderFee.getDistance());
        feeRuleRequest.setWaitMinute(feeRuleRequest.getWaitMinute());
        feeRuleRequest.setStartTime(feeRuleRequest.getStartTime());
        //Drools使用
        //开启会话
